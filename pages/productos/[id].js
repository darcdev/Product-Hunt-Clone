...
const Producto = () => {
  ...
  if (Object.keys(producto).length === 0 && !error) return <h1>Cargando...</h1>;
  ...
  // revisar que el creador del producto sea el mismo del autenticado
  ...
  return (
    <Layout>
      <>
        {error ? (
          <Error404 mensaje="No hay productos existentes" />
        ) : (
